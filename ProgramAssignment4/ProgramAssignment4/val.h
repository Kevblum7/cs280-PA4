...
inline map<string, Value> symbolTable; //symbol Table of variable names and Value objects
inline queue <Value> * ValQue; //declare a pointer variable to a queue of Value objects
